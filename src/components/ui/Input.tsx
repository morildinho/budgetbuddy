    ...
    return (
      <div className="w-full">
        ...
        <input
          ...
          type={type}
          className={cn(
            "w-full rounded-xl border border-[var(--border-primary)] bg-[var(--bg-card)] px-3 py-2.5 text-sm text-[var(--text-primary)] placeholder:text-[var(--text-muted)] shadow-sm transition-colors duration-200",
